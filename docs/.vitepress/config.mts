...
export default defineConfig({
    title: "OpenImmo for Laravel",
    description: "Use Dtos and Converter to work with OpenImmo XML in Laravel.",
    themeConfig: {
        ...
        sidebar: [
            ...
            },
            {
                ...
                items: [
                    {text: 'Converter', link: '/converter'},
                    {text: 'Schema Generation', link: '/schemas'},
        ...
        socialLinks: [
            {icon: 'github', link: 'https://github.com/innobraingmbh/laravel-openimmo'},
            {
                icon: {
