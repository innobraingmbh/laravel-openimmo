...
use Katalam\OpenImmo\Dtos\ActualRentalIncome;
use Katalam\OpenImmo\Dtos\AdditionalAddress;
use Katalam\OpenImmo\Dtos\AdditionalCostsPerSqmFrom;
use Katalam\OpenImmo\Dtos\Age;
...
use Katalam\OpenImmo\Dtos\Areas;
use Katalam\OpenImmo\Dtos\AttachedGastronomy;
use Katalam\OpenImmo\Dtos\Attachment;
use Katalam\OpenImmo\Dtos\Attachments;
use Katalam\OpenImmo\Dtos\Auction;
use Katalam\OpenImmo\Dtos\BalconyTerraceOrientation;
use Katalam\OpenImmo\Dtos\Basement;
use Katalam\OpenImmo\Dtos\Bathroom;
use Katalam\OpenImmo\Dtos\BiddingProcess;
use Katalam\OpenImmo\Dtos\BroadbandAccess;
use Katalam\OpenImmo\Dtos\Check;
use Katalam\OpenImmo\Dtos\CommercialLeisureProperty;
use Katalam\OpenImmo\Dtos\CommissionSplit;
use Katalam\OpenImmo\Dtos\Condition;
use Katalam\OpenImmo\Dtos\ConditionInformation;
use Katalam\OpenImmo\Dtos\ConstructionMethod;
use Katalam\OpenImmo\Dtos\ContactPerson;
use Katalam\OpenImmo\Dtos\Country;
use Katalam\OpenImmo\Dtos\Currency;
use Katalam\OpenImmo\Dtos\Data;
use Katalam\OpenImmo\Dtos\DevelopableAccordingTo;
use Katalam\OpenImmo\Dtos\Development;
use Katalam\OpenImmo\Dtos\DevelopmentScope;
use Katalam\OpenImmo\Dtos\DevelopmentStage;
use Katalam\OpenImmo\Dtos\Distances;
use Katalam\OpenImmo\Dtos\Elevator;
use Katalam\OpenImmo\Dtos\EnergyType;
use Katalam\OpenImmo\Dtos\Equipment;
use Katalam\OpenImmo\Dtos\Evaluation;
use Katalam\OpenImmo\Dtos\ExternalCommission;
use Katalam\OpenImmo\Dtos\Field;
use Katalam\OpenImmo\Dtos\Floor;
use Katalam\OpenImmo\Dtos\FreeTexts;
use Katalam\OpenImmo\Dtos\Furnished;
use Katalam\OpenImmo\Dtos\Gender;
use Katalam\OpenImmo\Dtos\Geo;
use Katalam\OpenImmo\Dtos\GeoCoordinates;
use Katalam\OpenImmo\Dtos\HallsStorageProduction;
use Katalam\OpenImmo\Dtos\HeatingType;
use Katalam\OpenImmo\Dtos\Hospitality;
use Katalam\OpenImmo\Dtos\House;
use Katalam\OpenImmo\Dtos\ImprintStructure;
use Katalam\OpenImmo\Dtos\Infrastructure;
use Katalam\OpenImmo\Dtos\InternalCommission;
use Katalam\OpenImmo\Dtos\Kitchen;
use Katalam\OpenImmo\Dtos\LocationInBuilding;
use Katalam\OpenImmo\Dtos\MarketingType;
use Katalam\OpenImmo\Dtos\Master;
use Katalam\OpenImmo\Dtos\MaxRentalPeriod;
use Katalam\OpenImmo\Dtos\MinRentalPeriod;
use Katalam\OpenImmo\Dtos\NetHeatingCosts;
use Katalam\OpenImmo\Dtos\NetMainRent;
use Katalam\OpenImmo\Dtos\NetOperatingCosts;
use Katalam\OpenImmo\Dtos\NetRentPerSqmFrom;
use Katalam\OpenImmo\Dtos\OpenImmo;
use Katalam\OpenImmo\Dtos\Other;
use Katalam\OpenImmo\Dtos\OtherEmail;
use Katalam\OpenImmo\Dtos\Parking;
use Katalam\OpenImmo\Dtos\ParkingCarport;
use Katalam\OpenImmo\Dtos\ParkingDuplex;
use Katalam\OpenImmo\Dtos\ParkingGarage;
use Katalam\OpenImmo\Dtos\ParkingMultiStorey;
use Katalam\OpenImmo\Dtos\ParkingOther;
use Katalam\OpenImmo\Dtos\ParkingOutdoor;
use Katalam\OpenImmo\Dtos\ParkingSpaceType;
use Katalam\OpenImmo\Dtos\ParkingUnderground;
use Katalam\OpenImmo\Dtos\Photo;
use Katalam\OpenImmo\Dtos\Plot;
use Katalam\OpenImmo\Dtos\Prices;
use Katalam\OpenImmo\Dtos\PriceTimeUnit;
use Katalam\OpenImmo\Dtos\PropertyCategory;
use Katalam\OpenImmo\Dtos\PropertyManagement;
use Katalam\OpenImmo\Dtos\PropertyText;
use Katalam\OpenImmo\Dtos\PropertyType;
use Katalam\OpenImmo\Dtos\Provider;
use Katalam\OpenImmo\Dtos\PurchasePrice;
use Katalam\OpenImmo\Dtos\RealEstate;
use Katalam\OpenImmo\Dtos\Retail;
use Katalam\OpenImmo\Dtos\RoofShape;
use Katalam\OpenImmo\Dtos\Rooms;
use Katalam\OpenImmo\Dtos\SalesStatus;
use Katalam\OpenImmo\Dtos\SecurityTechnology;
use Katalam\OpenImmo\Dtos\Services;
use Katalam\OpenImmo\Dtos\SportDistances;
use Katalam\OpenImmo\Dtos\TargetRentalIncome;
use Katalam\OpenImmo\Dtos\TechnicalManagement;
use Katalam\OpenImmo\Dtos\TotalCostsPerSqmFrom;
