...
class Energiepass
{
    public const string EPART_BEDARF = 'BEDARF';

    public const string EPART_VERBRAUCH = 'VERBRAUCH';

    public const string JAHRGANG_2008 = '2008';

    public const string JAHRGANG_2014 = '2014';

    public const string JAHRGANG_OHNE = 'ohne';

    public const string JAHRGANG_NICHT_NOETIG = 'nicht_noetig';

    public const string JAHRGANG_BEI_BESICHTIGUNG = 'bei_besichtigung';

    public const string GEBAEUDEART_WOHN = 'wohn';
